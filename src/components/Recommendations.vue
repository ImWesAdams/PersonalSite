    ...
    data() {
      return {
        ...
        upToItems: [
          ...
          {id: uniqueId('recom-'), date: 'Feb. 2022', category: 'Music', name: 'Dragon New Warm Mountain I Believe in You by Big Thief', description: 'Interesting folk/indie music with a really intricate depth of sound.', link: 'https://music.youtube.com/playlist?list=OLAK5uy_nNHQ7QfEZwCEAyDS7dXVdrXPe0-Mf6rLs&feature=share'},
